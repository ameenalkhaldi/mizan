...
flowchart TD
    ...
    TRIGGER["**SKILL.md** (343 lines)<br/>Detects trigger · Activates 4-pass pipeline"]

    MCP["**MCP Server**<br/>arabic-morphology<br/>Buckwalter DB<br/>82,158 stems"]
    REFS["**Reference Files**<br/>6 files · 4,959 lines<br/>Complete Arabic grammar"]
...
flowchart TD
    ...
    GR["**grammar-rules.md** (1,027 lines)<br/>كان · إنّ · ظنّ · أعطى · أرى<br/>كاد · ما الحجازية · المبني للمجهول<br/>الشرط · النصب · الجزم · لا النافية للجنس<br/>المصدر المؤول · المشتقات · نون التوكيد"]

    SC["**special-cases.md** (821 lines)<br/>الأسماء الخمسة · الأفعال الخمسة<br/>الممنوع من الصرف · التقديري · المحلي<br/>بناء الأفعال · الضمائر · العدد والمعدود"]

    RF["**roles-and-functions.md** (853 lines)<br/>المفعول المطلق · لأجله · فيه · معه<br/>نزع الخافض · المضاف إليه<br/>تعلّق شبه الجملة · مسوغات الابتداء"]

    SA["**sentence-analysis.md** (710 lines)<br/>التوابع: نعت · عطف · توكيد · بدل<br/>الحال · التمييز · الاستثناء · النداء<br/>٧ جمل لها محل · ٧ جمل لا محل"]

    AS["**asaleeb.md** (553 lines)<br/>التعجب · المدح/الذم · التفضيل<br/>القسم · الاشتغال · التنازع<br/>الاختصاص · الإغراء/التحذير<br/>أسماء الأفعال · لا سيّما · كم"]

    DIS["**disambiguation.md** (995 lines)<br/>ALWAYS LOADED<br/>11 particle decision trees<br/>Transitivity heuristics<br/>Undiacritized text rules<br/>Scope resolution"]
...
flowchart LR
    ...
    subgraph NAHW["**نحو (Syntax)**<br/>REASONING — Decision Trees"]
        direction TB
...
| File | Lines | Contents |
|------|------:|---------|
| `skill/SKILL.md` | 343 | Main skill: 4-pass pipeline, case signs table, error prevention, MCP integration |
| `grammar/grammar-rules.md` | 1,027 | النواسخ, الحروف العاملة, المبني للمجهول, المشتقات, المصدر المؤول |
| `grammar/disambiguation.md` | 995 | 11 particle decision trees, transitivity, tashkeel disambiguation, scope |
| `grammar/roles-and-functions.md` | 853 | المفاعيل الخمسة, المضاف إليه, تعلّق شبه الجملة, مسوغات |
| `grammar/special-cases.md` | 821 | العلامات الفرعية, بناء الأفعال, الضمائر, العدد والمعدود |
| `grammar/sentence-analysis.md` | 710 | التوابع, الحال, التمييز, 7+7 جمل لها/ليس لها محل |
| `grammar/asaleeb.md` | 553 | 12 أساليب نحوية (تعجب, مدح, تفضيل, قسم, ...) |
| `examples/examples.md` | 759 | 25 fully-worked canonical examples |
| `mcp-server/server.py` | 424 | MCP server wrapping Buckwalter (82,158 stems) |
| **Total** | **6,485** | |
